...
const INITIAL_INITIATIVES = [
  {
    ...
    description: "Establish common delivery definitions, measurement fields, baseline data, and an agreed calculation approach for Objective 5. Define deliverable categories; define major (structural) vs minor rework; set up Jira committed-date fields + acceptance flags; run a pilot + baseline measurement; recalibrate the improvement-delta targets.",
    owner: "Leen",
    ...
    deliverables: ["Initiative Plan and Measurement Plan","Approved BA Deliverable Categories","Objective 5 Measurement Definitions"],
    milestoneIds: [],
    dependencies: [],
    risks: [],
    latestUpdate: "Detailed 6-phase plan loaded (Initiation → Categories → Measurement Rules → Jira Fields → Pilot/Baseline → Analysis).",
    notes: "Dates follow the detailed rollout plan: starts Mon 6 Jul 2026 (shifted 20 days earlier from the original 26 Jul plan), Sun–Thu working week. Re-verify weekday alignment and fixed KSA public-holiday exclusions against the shifted dates.",
    evidenceLinks: [],
  ...
  },
  {
    ...
    objective: "Objective 5 — Delivery Excellence",
    description: "Improve estimation, dependency management, committed-date control, and date renegotiation practices across BA engagements. Assess current estimation practices, develop an estimation framework, establish dependency/RAID management, define committed-date governance, pilot, then roll out.",
    owner: "BA Leads",
    ...
    deliverables: ["BA Deliverable Estimation Framework","Committed-Date and Renegotiation Protocol"],
    milestoneIds: [],
    dependencies: [],
    risks: [],
    latestUpdate: "Not yet started — depends on Initiative 1 definitions and baseline.",
    notes: "Dates follow the detailed rollout plan (Sun–Thu working week, KSA holidays excluded). Update as work progresses.",
    evidenceLinks: [],
    createdDate: "2026-07-20",
    updatedDate: "2026-07-20",
    archived: false,
  ...
  },
  {
    ...
    dependencies: [],
    risks: [],
    latestUpdate: "Not yet started — depends on Objective 6 quality standards. Eid al-Fitr planning gap (shifted with the plan) included with no tasks scheduled.",
    notes: "Dates follow the detailed rollout plan; Founding Day (22 Feb 2027) excluded. Verify Eid al-Fitr dates against your company's approved holiday calendar.",
    evidenceLinks: [],
    createdDate: "2026-07-20",
    updatedDate: "2026-07-20",
    archived: false,
  ...
  },
  {
    ...
    objective: "Objective 5 — Delivery Excellence",
    description: "Review delivery performance quarterly, analyze missed targets, and feed lessons back into estimation, quality, dependency, and planning practices. Recurring 5-working-day cycle: prepare KPI results, analyze misses and root causes, define corrective actions, present and close the quarterly review.",
    owner: "Leen",
    support: ["BA Leads"],
    ...
    dependencies: [],
    risks: [],
    latestUpdate: "Four review cycles scheduled: Q1 (28 Sep – 2 Oct 2026), Q2 (28 Dec 2026 – 1 Jan 2027), Q3 (29 Mar – 2 Apr 2027), Q4 (28 Jun – 2 Jul 2027).",
...
function initialActivities() {
  ...
  const PLAN = {
    "OBJ5-INIT-01": [
      { name: "1.1 Initiation and Measurement Planning", start: "2026-07-06", end: "2026-07-17", deliverable: "Initiative Plan and Measurement Plan",
        subtasks: [
      ...
      { name: "1.2 Define Deliverable Categories", start: "2026-07-20", end: "2026-07-31", deliverable: "Approved BA Deliverable Categories",
        subtasks: [
      ...
      { name: "1.3 Define Measurement Rules", start: "2026-08-03", end: "2026-08-14", deliverable: "Objective 5 Measurement Definitions",
        subtasks: [
      ...
      { name: "1.4 Configure Jira Measurement Fields", start: "2026-08-17", end: "2026-08-28", owner: "Jira Admin",
        subtasks: [
      ...
      { name: "1.5 Pilot and Baseline Measurement", start: "2026-08-31", end: "2026-09-25",
        notes: "Plan shifted to start 6 Jul 2026 — re-check fixed KSA public holidays (e.g. National Day 23 Sep) against the new dates. Original 2–3 month measurement window can extend into Q2 for a more reliable baseline.",
        subtasks: [
      ...
      { name: "1.6 Analyze Baseline and Recalibrate Targets", start: "2026-09-28", end: "2026-10-02", milestone: "Initial Delivery Baseline Approved",
        subtasks: [
    ...
    "OBJ5-INIT-02": [
      { name: "2.1 Assess Current Estimation Practices", start: "2026-10-05", end: "2026-10-16", owner: "BA Leads",
        subtasks: [
          ["Collect Current Estimation Methods", "2026-10-05", "2026-10-07"],
          ["Review Project Plan Samples", "2026-10-08", "2026-10-09"],
          ["Interview BA Leads on Estimation Challenges", "2026-10-12", "2026-10-13"],
          ["Analyze Causes of Inaccurate Estimates", "2026-10-14", "2026-10-15"],
          ["Prepare Current-State Report", "2026-10-16", "2026-10-16"],
        ]},
      { name: "2.2 Develop the Estimation Framework", start: "2026-10-19", end: "2026-10-30", deliverable: "BA Deliverable Estimation Framework", owner: "BA Leads",
        subtasks: [
          ...
          ["Define Integrations and Dependencies Impact", "2026-10-26", "2026-10-26"],
      ...
      { name: "2.3 Establish Dependency and RAID Management", start: "2026-11-02", end: "2026-11-13", owner: "Leen",
        subtasks: [
          ...
          ["Define Dependency Tracking Responsibilities", "2026-11-10", "2026-11-10"],
          ["Define Escalation Mechanism", "2026-11-11", "2026-11-11"],
          ["Review and Approve Templates", "2026-11-12", "2026-11-13"],
        ]},
      { name: "2.4 Define Committed-Date Governance", start: "2026-11-16", end: "2026-12-04", deliverable: "Committed-Date and Renegotiation Protocol", owner: "BA Leads",
        subtasks: [
          ["Define Original Date Approval Mechanism", "2026-11-16", "2026-11-17"],
          ...
          ["Review Process with Portfolio Managers", "2026-12-03", "2026-12-03"],
          ["Approve Process", "2026-12-04", "2026-12-04"],
        ]},
      { name: "2.5 Pilot the Delivery Discipline", start: "2026-12-07", end: "2026-12-25", owner: "BA Leads",
        subtasks: [
          ...
          ["Apply Date Commit and Change Mechanism", "2026-12-21", "2026-12-22"],
          ["Collect Feedback", "2026-12-23", "2026-12-24"],
          ["Analyze Pilot Results", "2026-12-25", "2026-12-25"],
        ]},
      { name: "2.6 Finalize and Roll Out", start: "2026-12-28", end: "2027-01-01", owner: "Portfolio Managers", milestone: "Delivery Discipline Launched",
        subtasks: [
    ...
    "OBJ5-INIT-03": [
      { name: "3.1 Define First-Review Acceptance Rules", start: "2027-01-04", end: "2027-01-15",
        subtasks: [
          ["Review Deliverable Acceptance Documentation Methods", "2027-01-04", "2027-01-06"],
          ["Catalog Acceptance and Rejection Scenarios", "2027-01-07", "2027-01-08"],
      ...
      { name: "3.2 Create Structured Feedback and Sign-Off Record", start: "2027-01-18", end: "2027-01-29",
        subtasks: [
          ...
          ["Add Major and Minor Rework Classification", "2027-01-26", "2027-01-26"],
      ...
      { name: "3.3 Define Pre-Submission Quality Requirements", start: "2027-02-01", end: "2027-02-12",
        notes: "Plan shifted to start 6 Jul 2026 — re-check the Founding Day (22 Feb) exclusion against the new dates.",
        subtasks: [
          ["Review Objective 6 Standards", "2027-02-01", "2027-02-03"],
          ["Define Requirements-Completeness Criteria", "2027-02-04", "2027-02-05"],
          ["Define BRD Scoping Rules", "2027-02-08", "2027-02-08"],
          ["Define Document-Size Controls", "2027-02-09", "2027-02-09"],
          ["Define File Structure Confirmation Requirements", "2027-02-10", "2027-02-10"],
          ["Define Template-Compliance Criteria", "2027-02-11", "2027-02-11"],
          ["Approve Quality Requirements", "2027-02-12", "2027-02-12"],
        ]},
      { name: "3.4 Develop the BA Pre-Submission Checklist", start: "2027-02-22", end: "2027-03-12", deliverable: "Reusable BA Pre-Submission Checklist Template",
        notes: "Eid al-Fitr gap shifted with the plan (per SAMA reference schedule) — re-verify exact Eid dates against your company holiday calendar.",
        subtasks: [
          ...
          ["Add Dependencies and Decisions Section", "2027-03-09", "2027-03-09"],
      ...
      { name: "3.5 Pilot the Checklist and Acceptance Record", start: "2027-03-15", end: "2027-03-26",
        subtasks: [
      ...
      { name: "3.6 Final Approval and Rollout", start: "2027-03-29", end: "2027-04-02", milestone: "Pre-Submission Checklist Launched",
        subtasks: [
          ["Update Checklist and Acceptance Record", "2027-03-29", "2027-03-30"],
          ["Prepare Usage Guide", "2027-03-31", "2027-03-31"],
          ["Obtain Final Approval", "2027-04-01", "2027-04-01"],
          ["Roll Out Template Across the Department", "2027-04-02", "2027-04-02"],
        ]},
    ],
  };
    ...
    primaries.forEach((p, pIdx) => {
      ...
      (p.subtasks || []).forEach(([name, start, end], sIdx) => {
        activities.push(task({
          ...
          parentActivityId: primaryTask.id, order: sIdx,
        }));
      });
      if (p.milestone) {
        activities.push(task({
  ...
  const REVIEW_CYCLES = [
    { label: "Q1 Review", d1: "2026-09-28", d23s: "2026-09-29", d23e: "2026-09-30", d4: "2026-10-01", d5: "2026-10-02" },
    { label: "Q2 Review", d1: "2026-12-28", d23s: "2026-12-29", d23e: "2026-12-30", d4: "2026-12-31", d5: "2027-01-01" },
    { label: "Q3 Review", d1: "2027-03-29", d23s: "2027-03-30", d23e: "2027-03-31", d4: "2027-04-01", d5: "2027-04-02" },
    { label: "Q4 Review", d1: "2027-06-28", d23s: "2027-06-29", d23e: "2027-06-30", d4: "2027-07-01", d5: "2027-07-02" },
  ];
  const CYCLE_SUBTASKS = {
    "4.1 Prepare KPI Results": ["Extract Deliverables List","Validate Date Completeness","Calculate On-Time Delivery Rate","Calculate First-Review Acceptance Rate","Calculate Delivery Excellence Index","Compare Result to Target"],
    "4.2 Analyze Misses and Root Causes": ["Identify Late Deliverables","Identify Deliverables Needing Major Rework","Review Delay Causes","Review Rework Causes","Classify Causes","Identify Recurring Causes","Identify Most-Affected Projects and Portfolios"],
    "4.3 Define Corrective Actions": ["Propose Corrective Actions","Assign Action Owners","Set Target Dates","Flag Actions Needing Escalation","Update Estimation Framework","Update Dependency Log","Update Pre-Submission Checklist as Needed"],
    "4.4 Present and Close the Quarterly Review": ["Prepare Executive Summary","Present Results to BA Leads","Document Decisions","Approve Corrective Actions","Publish Quarterly Report","Carry Open Actions to Next Quarter"],
  };
  REVIEW_CYCLES.forEach((cycle, cIdx) => {
    const phases = [
      { name: `4.1 Prepare KPI Results (${cycle.label})`, start: cycle.d1, end: cycle.d1 },
      { name: `4.2 Analyze Misses and Root Causes (${cycle.label})`, start: cycle.d23s, end: cycle.d23e },
      { name: `4.3 Define Corrective Actions (${cycle.label})`, start: cycle.d4, end: cycle.d4 },
      { name: `4.4 Present and Close the Quarterly Review (${cycle.label})`, start: cycle.d5, end: cycle.d5, milestone: cIdx === 0 || true ? "Quarterly Delivery Excellence Review Completed" : null },
    ];
    let prevCyclePhaseId = null;
    phases.forEach((ph, phIdx) => {
      const baseKey = ph.name.replace(` (${cycle.label})`, "");
      const primaryTask = task({
        initiativeId: "OBJ5-INIT-04", name: ph.name, plannedStart: ph.start, plannedEnd: ph.end,
        recurring: true, recurrenceFrequency: "Quarterly", order: cIdx * 4 + phIdx,
      });
      ...
      (CYCLE_SUBTASKS[baseKey] || []).forEach((name, sIdx) => {
        activities.push(task({
          initiativeId: "OBJ5-INIT-04", name, plannedStart: ph.start, plannedEnd: ph.end,
          parentActivityId: primaryTask.id, order: sIdx,
        }));
      });
      if (ph.milestone) {
        activities.push(task({
          initiativeId: "OBJ5-INIT-04", name: `Milestone: ${ph.milestone} (${cycle.label})`, plannedStart: ph.end, plannedEnd: ph.end,
          milestone: true, order: 100 + cIdx,
        }));
      }
    });
  });
...
function defaultData() {
  return {
    ...
    savedViews: [
      ...
      { id: uid("VIEW"), name: "Leen's open actions", filter: { owner: "Leen" } },
    ],
...
function computeObjectiveHealth(initiatives, activities, risks, kpiResults, thresholds) {
  const active = initiatives.filter(i => !i.archived);
  const delayed = active.filter(i => i.status === "Delayed" || i.status === "At Risk").length;
...
function AppShell({ data, update, log, dirty, saving, onSave, search, setSearch, drawer, setDrawer, confirmState, setConfirmState, importState, setImportState, fileInputRef, push, children }) {
  ...
  const health = computeObjectiveHealth(activeInitiatives, data.activities, activeRisks, data.kpiResults, data.settings.riskThresholds);
          ...
          <main style={{ flex: 1, padding: "22px 26px", maxWidth: 1500, width: "100%", margin: "0 auto" }}>
            {search.trim() ? (
              ...
              <>
                ...
                {activeTab === "kpi" && <KPITab data={data} update={update} log={log} push={push} />}
...
function GlobalSearchResults({ data, query, onClear, setDrawer, setActiveTab }) {
  ...
  return (
    <div>
      ...
      {[["Initiatives", initiatives, "initiatives"], ["Activities", activities, "timeline"], ["Risks & Dependencies", risks, "risks"], ["Alignments", alignments, "alignments"]].map(([label, list, tab]) => (
...
function OverviewTab({ data, update, log, health, setActiveTab, exportJSON, setDrawer }) {
  ...
  const overallProgress = initiatives.length ? Math.round(initiatives.reduce((s,i)=>s+clampProgress(i.progress),0)/initiatives.length) : 0;
  ...
  const latestKpiFor = (metric) => {
    const rows = data.kpiResults.filter(r => r.metric === metric).sort((a,b)=> b.reportingPeriod.localeCompare(a.reportingPeriod));
    return rows[0];
  };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 12 }}>
        <KPICard label="Objective Progress" value={`${overallProgress}%`} sub="Average of initiative progress" />
        <KPICard label="Delivery Excellence Index" value={dei ? `${dei.calculatedPct}%` : "No data"} sub={dei ? `Target ${dei.target}%` : "Not yet measured"} />
        <KPICard label="On-Time Delivery Rate" value={otd ? `${otd.calculatedPct}%` : "No data"} sub={otd ? `Target ${otd.target}%` : "Not yet measured"} />
        <KPICard label="First-Review Acceptance" value={fra ? `${fra.calculatedPct}%` : "No data"} sub={fra ? `Target ${fra.target}%` : "Not yet measured"} />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 16 }}>
        <div style={{ background: "#fff", border: "1px solid #e2e7ee", borderRadius: 12, padding: 18 }}>
          <div style={{ fontWeight: 700, color: "#0f2a52", marginBottom: 10 }}>Initiative Progress Summary</div>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {initiatives.map(i => (
              <div key={i.id}>
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13, marginBottom: 4 }}>
                  <span style={{ fontWeight: 600 }}>{i.id} · {i.name}</span>
                  <span style={{ color: "#64748b" }}>{i.progress}% · <Badge tone={statusTone(i.status)}>{i.status}</Badge></span>
                </div>
                <div style={{ height: 8, background: "#eef1f5", borderRadius: 999, overflow: "hidden" }}>
                  <div style={{ width: `${clampProgress(i.progress)}%`, height: "100%", background: "#0f2a52" }} />
                </div>
              </div>
            ))}
          </div>
...
function TimelineTab({ data, update, log, drawer, setDrawer, push, confirmState, setConfirmState }) {
  ...
  const dropReorder = (draggedId, targetAct) => {
    ...
    if (dragged.initiativeId !== targetAct.initiativeId || (dragged.parentActivityId||null) !== (targetAct.parentActivityId||null)) {
      push("You can only reorder within the same initiative and task level.", "error");
      return;
    }
  ...
  const quarterMarks = OBJECTIVE5_QUARTERS;
  ...
  return (
    <div>
      ...
      {view === "List" ? (
        ...
        <div style={{ background: "#fff", border: "1px solid #e2e7ee", borderRadius: 12, overflow: "hidden" }}>
          <div style={{ display: "flex", borderBottom: "1px solid #e2e7ee", background: "#f7f8fa" }}>
            <div style={{ width: 300, flexShrink: 0, padding: "10px 14px", fontWeight: 700, fontSize: 12, color: "#64748b" }}>INITIATIVE / ACTIVITY</div>
            <div ref={containerRef} style={{ flex: 1, position: "relative", padding: "10px 0", display: "flex" }}>
              {quarterMarks.map(q => <div key={q.label} title={q.range} style={{ flex: 1, textAlign: "center", fontSize: 12, fontWeight: 700, color: "#64748b", borderLeft: "1px solid #e2e7ee" }}>{q.label}<div style={{ fontSize: 10, fontWeight: 500, color: "#94a3b8" }}>{q.range}</div></div>)}
            </div>
          </div>
              ...
              <div key={init.id}>
                <div style={{ display: "flex", alignItems: "center", background: "#eef1f5", borderBottom: "1px solid #e2e7ee" }}>
                  <button onClick={() => setCollapsed(c => ({ ...c, [init.id]: !c[init.id] }))}
                    style={{ width: 300, flexShrink: 0, display: "flex", alignItems: "center", gap: 6, padding: "9px 14px", border: "none", background: "transparent", cursor: "pointer", fontWeight: 700, fontSize: 13, color: "#0f2a52", textAlign: "left" }}>
                    {isCollapsed ? <ChevronRight size={14} /> : <ChevronDown size={14} />} {init.id} · {init.name}
                  </button>
                  <div style={{ flex: 1, padding: "9px 14px", fontSize: 12, color: "#64748b" }}>{init.owner} · {init.progress}% complete</div>
                </div>
...
function TimelineRow({ activity, dayToPct, onMouseDownDrag, onClick, isPrimary, hasSubtasks, subCollapsed, onToggleSub, onAddSubtask, indent, canMoveUp, canMoveDown, onMoveUp, onMoveDown, isRowDragging, isRowDragOver, onRowDragStart, onRowDragOver, onRowDrop, onRowDragEnd }) {
      ...
      <div style={{ flex: 1, position: "relative", height: 30 }}>
        {activity.milestone ? (
          ...
          <div
            ...
            onClick={onClick}
          >
            <div style={{ width: `${clampProgress(activity.progress)}%`, height: "100%", background: "rgba(255,255,255,0.35)", borderRadius: 5 }} />
...
function InitiativesTab({ data, update, log, drawer, setDrawer, push, confirmState, setConfirmState }) {
  ...
  const duplicate = (init) => {
    const copy = { ...init, id: uid("OBJ5-INIT"), name: init.name + " (Copy)", createdDate: todayISO(), updatedDate: todayISO(), order: data.initiatives.length };
    update(p => ({ ...p, initiatives: [...p.initiatives, copy] }));
    log({ action: "Added", recordType: "Initiative", recordName: copy.name, previousValue: "", newValue: `Duplicated from ${init.id}` });
    push("Initiative duplicated");
  };
  const archive = (init) => {
    update(p => ({ ...p, initiatives: p.initiatives.map(i => i.id === init.id ? { ...i, archived: true } : i) }));
    log({ action: "Archived", recordType: "Initiative", recordName: init.name, previousValue: "Active", newValue: "Archived" });
    push("Initiative archived");
  };
  const restore = (init) => {
    update(p => ({ ...p, initiatives: p.initiatives.map(i => i.id === init.id ? { ...i, archived: false } : i) }));
    log({ action: "Restored", recordType: "Initiative", recordName: init.name, previousValue: "Archived", newValue: "Active" });
    push("Initiative restored");
  };
  const remove = (init) => {
    setConfirmState({
      title: "Delete initiative?", message: `Permanently delete "${init.name}" and unlink its activities? This cannot be undone.`,
      onConfirm: () => {
        update(p => ({ ...p, initiatives: p.initiatives.filter(i => i.id !== init.id) }));
        log({ action: "Deleted", recordType: "Initiative", recordName: init.name, previousValue: "Existed", newValue: "Removed" });
    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 10, marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <Button variant="primary" icon={Plus} onClick={openNew}>Add initiative</Button>
        </div>
      </div>
            ...
            <div key={init.id} style={{ background: "#fff", border: "1px solid #e2e7ee", borderRadius: 12, padding: 16, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <div>
                <div style={{ height: 7, background: "#eef1f5", borderRadius: 999, overflow: "hidden" }}>
                  <div style={{ width: `${clampProgress(init.progress)}%`, height: "100%", background: "#0f2a52" }} />
                </div>
                <div style={{ fontSize: 11.5, color: "#8592a3", marginTop: 3 }}>{init.progress}% complete · Owner: {init.owner}</div>
              </div>
...
function InitiativeDrawer({ data, update, log, initiativeId, isNew, onClose, push, setConfirmState }) {
  ...
  const [form, setForm] = useState(existing || {
    id: uid("OBJ5-INIT"), name: "", objective: "Objective 5 — Delivery Excellence", description: "",
  ...
  const validate = () => {
    ...
    if (form.progress < 0 || form.progress > 100) return "Progress must be between 0% and 100%.";
    if (form.status === "Completed" && Number(form.progress) !== 100) return "Completed initiatives should normally have 100% progress.";
    return "";
  };
  ...
  const save = () => {
    ...
    log({ action: isNew ? "Added" : "Edited", recordType: "Initiative", recordName: updated.name, previousValue: "", newValue: isNew ? "Created" : "Updated" });
    push(isNew ? "Initiative added" : "Initiative saved");
    onClose();
  };

  return (
    <Modal open onClose={onClose} title={isNew ? "Add Initiative" : `${form.id} · ${form.name || "Initiative"}`} width={680}
      footer={<>
        <Button variant="secondary" onClick={onClose}>Cancel</Button>
        <Button variant="primary" icon={Save} onClick={save}>{isNew ? "Add Initiative" : "Save Changes"}</Button>
      </>}>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {error && <div style={{ background: "#fbe9e7", color: "#a3271f", padding: "8px 12px", borderRadius: 8, fontSize: 13 }}>{error}</div>}
        ...
        {!isNew && (
          <div>
            <div style={{ fontWeight: 700, fontSize: 13, color: "#0f2a52", marginTop: 6, marginBottom: 6 }}>Activities under this initiative ({activities.length})</div>
...
function KPITab({ data, update, log, push }) {
  ...
  const rows = data.kpiResults.filter(r => r.metric === metricFilter).sort((a,b)=>a.reportingPeriod.localeCompare(b.reportingPeriod));
  ...
  const addResult = (entry) => {
    ...
    const { pct, status, variance } = calcKpiResult(entry.numerator, entry.denominator, target, thresholds);
    if (Number(entry.numerator) > Number(entry.denominator)) { push("Numerator cannot exceed denominator", "error"); return false; }
    if (Number(entry.denominator) < 0) { push("Denominator cannot be negative", "error"); return false; }
    const dup = data.kpiResults.find(r => r.metric === entry.metric && r.reportingPeriod === entry.reportingPeriod);
    if (dup && !entry.confirmedReplace) {
      push("A record for this period already exists — confirm to replace it.", "error");
      return "duplicate";
    }
    const record = {
      id: dup ? dup.id : uid("KPI"), metric: entry.metric, reportingPeriod: entry.reportingPeriod,
      numerator: Number(entry.numerator), denominator: Number(entry.denominator),
      calculatedPct: pct, target, variance, performanceStatus: status,
      dataSource: entry.dataSource || "Manual KPI Entry", evidenceLink: entry.evidenceLink || "",
      enteredBy: data.settings.userDisplayName, entryDate: todayISO(), notes: entry.notes || "",
    };
    update(p => ({
      ...p,
      kpiResults: dup ? p.kpiResults.map(r => r.id === dup.id ? record : r) : [...p.kpiResults, record],
    }));
    log({ action: dup ? "Edited" : "Added", recordType: "KPI Result", recordName: `${entry.metric} — ${entry.reportingPeriod}`, previousValue: dup ? `${dup.calculatedPct}%` : "", newValue: `${pct}%` });
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          <Select value={metricFilter} onChange={e=>setMetricFilter(e.target.value)} style={{ width: 260 }}>
            {metrics.map(m => <option key={m}>{m}</option>)}
          </Select>
          <Select value={periodMode} onChange={e=>setPeriodMode(e.target.value)} style={{ width: 140 }}>
            <option>Monthly</option><option>Quarterly</option>
          </Select>
          <Select value={valueMode} onChange={e=>setValueMode(e.target.value)} style={{ width: 200 }}>
            <option>Percentage</option><option>Numerator/Denominator</option>
          </Select>
        </div>
        <Button variant="primary" icon={Plus} onClick={()=>setShowEntry(true)}>Add KPI result</Button>
      </div>

      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 12 }}>
        <KPICard label="Latest measurement" value={latest ? `${latest.calculatedPct}%` : "No data"} sub={latest ? fmtDate(latest.entryDate) : "Not yet measured"} />
        <KPICard label="Target (latest quarter)" value={def.targets["Q4 2026"] ? `${def.targets["Q4 2026"]}%` : "—"} sub="Q4 2026 target" />
        <KPICard label="Variance from target" value={latest && latest.variance != null ? `${latest.variance > 0 ? "+" : ""}${latest.variance} pts` : "—"} />
        <KPICard label="Baseline status" value={def.baseline} sub={def.baselineExplanation} />
      </div>

      <div style={{ background: "#fff", border: "1px solid #e2e7ee", borderRadius: 12, padding: 18 }}>
        <div style={{ fontWeight: 700, color: "#0f2a52", marginBottom: 4 }}>{metricFilter} — Target vs Actual</div>
        <div style={{ fontSize: 12, color: "#8592a3", marginBottom: 10 }}>{def.formula} · Measured {def.frequency.toLowerCase()}</div>
        {chartData.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height={280}>
            {valueMode === "Percentage" ? (
              <LineChart data={chartData}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="Actual" stroke="#0f2a52" strokeWidth={2} dot={{ r: 4 }} />
                <Line type="monotone" dataKey="Target" stroke="#c2410c" strokeDasharray="5 5" strokeWidth={2} dot={false} />
              </LineChart>
            ) : (
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          <thead>
            <tr style={{ background: "#f7f8fa" }}>
              {["Period","Numerator","Denominator","Actual %","Target %","Variance","Status","Entered By"].map(h => (
          ...
          <tbody>
            {rows.map(r => (
              <tr key={r.id} style={{ borderBottom: "1px solid #f0f2f5" }}>
                ...
                <td style={{ padding: "9px 12px", fontWeight: 700 }}>{r.calculatedPct}%</td>
                <td style={{ padding: "9px 12px" }}>{r.target != null ? `${r.target}%` : "—"}</td>
                <td style={{ padding: "9px 12px" }}>{r.variance != null ? `${r.variance > 0 ? "+" : ""}${r.variance}` : "—"}</td>
                <td style={{ padding: "9px 12px" }}><Badge tone={{"Above Target":"green","On Target":"green","Slightly Below Target":"amber","Significantly Below Target":"red","No Data":"neutral"}[r.performanceStatus]}>{r.performanceStatus}</Badge></td>
                <td style={{ padding: "9px 12px" }}>{r.enteredBy}</td>
              </tr>
            ))}
            {rows.length === 0 && <tr><td colSpan={8} style={{ padding: 16, textAlign: "center", color: "#94a3b8" }}>No records yet.</td></tr>}
          </tbody>
        </table>
      </div>

      {showEntry && <KPIEntryModal data={data} metricDefault={metricFilter} onClose={()=>setShowEntry(false)} addResult={addResult} />}
    </div>
  );
}
...
function KPIEntryModal({ data, metricDefault, onClose, addResult }) {
  ...
  const quarter = period ? (periodType === "Monthly" ? quarterOfDate(period + "-01") : period) : "";
  const target = def.targets[quarter] ?? def.targets["Q4 2026"];

  const submit = (confirmReplace=false) => {
    if (!period) { setError("Reporting period is required."); return; }
    if (numerator === "" || denominator === "") { setError("Numerator and denominator are required."); return; }
    if (Number(numerator) > Number(denominator)) { setError("Numerator cannot exceed denominator."); return; }
    if (Number(denominator) < 0) { setError("Denominator cannot be negative."); return; }
    setError("");
    const result = addResult({ metric, reportingPeriod: period, numerator, denominator, target, dataSource, evidenceLink, notes, confirmedReplace: confirmReplace });
    if (result === "duplicate") { setNeedsConfirm(true); return; }
    if (result) onClose();
  };

  return (
    <Modal open onClose={onClose} title="Add KPI Result" width={520}
      footer={<>
        <Button variant="secondary" onClick={onClose}>Cancel</Button>
        {needsConfirm
          ? <Button variant="danger" onClick={()=>submit(true)}>Replace existing record</Button>
          : <Button variant="primary" icon={Save} onClick={()=>submit(false)}>Save Result</Button>}
      </>}>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {error && <div style={{ background: "#fbe9e7", color: "#a3271f", padding: "8px 12px", borderRadius: 8, fontSize: 13 }}>{error}</div>}
        <Field label="Metric"><Select value={metric} onChange={e=>setMetric(e.target.value)}>{Object.keys(data.kpiDefs).map(m=><option key={m}>{m}</option>)}</Select></Field>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          <Field label="Period type">
            <Select value={periodType} onChange={e=>setPeriodType(e.target.value)}><option>Monthly</option><option>Quarterly</option></Select>
          </Field>
          <Field label="Reporting period">
            {periodType === "Monthly"
              ? <Input type="month" value={period} onChange={e=>setPeriod(e.target.value)} />
              : <Select value={period} onChange={e=>setPeriod(e.target.value)}><option value="">Select</option>{QUARTERS_2026.map(q=><option key={q}>{q}</option>)}</Select>}
          </Field>
          <Field label="Numerator"><Input type="number" value={numerator} onChange={e=>setNumerator(e.target.value)} /></Field>
          <Field label="Denominator"><Input type="number" value={denominator} onChange={e=>setDenominator(e.target.value)} /></Field>
        </div>
        <div style={{ fontSize: 12.5, color: "#64748b", background: "#f7f8fa", padding: "8px 12px", borderRadius: 8 }}>
          Calculated: {(numerator!=="" && denominator!=="" && Number(denominator)>0) ? `${((Number(numerator)/Number(denominator))*100).toFixed(1)}%` : "—"} · Target for {quarter || "selected period"}: {target != null ? `${target}%` : "—"}
        </div>
        <Field label="Data source"><Select value={dataSource} onChange={e=>setDataSource(e.target.value)}><option>Calculated from Deliverable Register</option><option>Manual KPI Entry</option><option>Hybrid</option></Select></Field>
        <Field label="Evidence link"><Input value={evidenceLink} onChange={e=>setEvidenceLink(e.target.value)} placeholder="https://…" /></Field>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <section style={{ background: "#fff", border: "1px solid #e2e7ee", borderRadius: 12, padding: 18 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
          ...
          <Button variant="secondary" icon={Download} onClick={()=>exportCSV(data.initiatives, "initiatives.csv", ["id","name","owner","status","priority","confidence","progress","deadline"])}>Export initiatives (CSV)</Button>
      ...
      {importState && (
        <Modal open onClose={()=>setImportState(null)} title={`Import "${importState.fileName}"`} width={480}
          ...
          <p style={{ fontSize: 13.5, color: "#334155" }}>
            This file contains {importState.parsed.initiatives?.length ?? 0} initiatives, {importState.parsed.activities?.length ?? 0} activities,
