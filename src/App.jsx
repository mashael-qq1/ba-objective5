...
// Internal rollout quarters for the Objective 5 initiative timeline. Windows are
// contiguous and derived from the release plans: 6 Jul 2026 → 30 Jun 2027,
// Sun–Thu working week, KSA public holidays excluded. `range` is a fallback label
// only — the timeline header reads its dates live from each release's plan.
// Kept separate from QUARTERS_2026 (used for calendar-year KPI measurement periods).
const OBJECTIVE5_QUARTERS = [
  {
    label: "Q1",
    range: "6 Jul 2026 – 22 Oct 2026",
    start: "2026-07-06",
    end: "2026-10-25",
  },
  {
    label: "Q2",
    range: "26 Oct 2026 – 10 Jan 2027",
    start: "2026-10-26",
    end: "2027-01-17",
  },
  {
    label: "Q3",
    range: "18 Jan 2027 – 1 Apr 2027",
    start: "2027-01-18",
    end: "2027-04-05",
  },
  {
    label: "Q4",
    range: "6 Apr 2027 – 30 Jun 2027",
    start: "2027-04-06",
    end: "2027-06-30",
  },
];
...
// "6 Jul – 1 Oct 2026" — the start year is shown only when it differs from the end year
function fmtRange(startISO, endISO) {
  ...
  return `${part(s, s.getFullYear() !== e.getFullYear())} – ${part(e, true)}`;
}
...
const INITIAL_INITIATIVES = [
  {
    ...
    actualStart: "",
    actualEnd: "",
    deadline: "Q1 (6 Jul 2026 – 22 Oct 2026)",
    status: "Planned",
    priority: "Critical",
    confidence: "High",
    progress: 0,
    ...
    deliverables: [
      "Transformation Roadmap and Executive Timeline",
      "Delivery Measurement Framework",
      "Jira Measurement Configuration",
      "BA Quality Checklist",
      "Delivery Excellence Pilot",
      "Initial Baseline",
      "Improvement Backlog",
    ],
    milestoneIds: [],
    ...
    risks: [],
    latestUpdate:
      "Pilot roadmap loaded: Preparation → Current Baseline → Framework → Jira Setup → Checklist → Pilot → Measurement → Improvements. Current Baseline Approved lands 27 Aug 2026; Pilot Live and measured lands 21 Oct 2026, before the end of Q1.",
    notes:
      "Pilot-first delivery strategy — each quarter delivers usable business value. Preparation phase 6 Jul – 9 Aug 2026 (no KPI implementation); implementation starts 9 Aug 2026 with the Current Baseline assessment. All dates fall on Sun–Thu working days; Saudi National Day (23 Sep 2026) excluded.",
    evidenceLinks: [],
  ...
  },
  {
    ...
    objective: "Objective 5 — Delivery Excellence",
    description:
      "Q2 — Improve the Pilot and expand it beyond the single project. Enhance the estimation and dependency framework, strengthen quality controls (structured feedback record and improved BA checklist), optimise the Jira workflow, expand the pilot to multiple projects, then measure and compare performance against the Q1 baseline and plan the next improvements.",
    owner: "BA Leads",
    ...
    actualStart: "",
    actualEnd: "",
    deadline: "Q2 (26 Oct 2026 – 10 Jan 2027)",
    status: "Planned",
    priority: "High",
    confidence: "Medium",
    progress: 0,
    ...
    deliverables: [
      "Enhanced Estimation & Dependency Framework",
      "Structured Feedback & Sign-Off Record",
    ...
    risks: [],
    latestUpdate:
      "Not yet started — depends on the Q1 Pilot being live and the initial baseline being approved.",
    notes:
      "Q2 expands the Pilot to multiple projects (projects 2–4) and measures each one. Sun–Thu working week, KSA holidays excluded. Roll-out completes 15 Dec 2026; per-project measurement milestones land 27–31 Dec 2026.",
    evidenceLinks: [],
    createdDate: "2026-07-20",
    updatedDate: "2026-07-20",
    archived: false,
  ...
  },
  {
    ...
    actualStart: "",
    actualEnd: "",
    deadline: "Q3 (18 Jan 2027 – 1 Apr 2027)",
    status: "Planned",
    priority: "High",
    confidence: "Medium",
    progress: 0,
    ...
    risks: [],
    latestUpdate:
      "Not yet started — depends on the Q2 expanded pilot results. Department Rollout Completed milestone lands 1 Apr 2027.",
    notes:
      "Department-wide rollout with governance. Sun–Thu working week; Founding Day (22 Feb 2027) and the Eid al-Fitr window (7–11 Mar 2027, SAMA reference) excluded — verify Eid dates against your company's approved holiday calendar.",
    evidenceLinks: [],
    createdDate: "2026-07-20",
    updatedDate: "2026-07-20",
    archived: false,
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Annual Delivery Excellence Report",
      "Roadmap for Year 2",
    ],
    milestoneIds: [],
    dependencies: [],
    risks: [],
    latestUpdate:
      "Not yet started — final release. Delivery Excellence Successfully Institutionalized milestone lands 30 Jun 2027.",
    notes:
      "Final optimisation release, ending before the 30 Jun 2027 project end. Sun–Thu working week. NOTE: Eid al-Adha 2027 falls inside this window but its exact dates were not confirmed — verify against your company holiday calendar and shift the affected activities.",
    evidenceLinks: [],
    createdDate: "2026-07-20",
    updatedDate: "2026-07-20",
    archived: false,
...
function initialActivities() {
  const task = (overrides) => ({
    ...
    status:
      overrides.status || (overrides.milestone ? "Not Started" : "Planned"),
  ...
  // Assumptions: plan starts Mon 6 Jul 2026 and ends Wed 30 Jun 2027; working week Sun–Thu; weekend Fri–Sat;
  ...
  const PLAN = {
    "RELEASE 1": [
      {
        name: "0. Project Preparation & Mobilization",
        start: "2026-07-06",
        end: "2026-08-09",
        deliverable: "Transformation Roadmap and Executive Timeline",
        notes:
          "Preparation only — no KPI implementation in this phase. Implementation starts 9 Aug 2026. Dates and progress below reflect the update saved on 3 Aug 2026.",
        subtasks: [
          [
            "Kick-off Meeting",
            "2026-07-15",
          ...
          [
            "Prepare Transformation Roadmap",
            "2026-07-30",
            "2026-07-30",
            {
              status: "Completed",
      ...
      {
        name: "1. Assess Current Delivery Performance (Establish Current Baseline)",
        start: "2026-08-09",
        end: "2026-08-27",
        deliverable: "Current Delivery Performance Baseline Report",
        notes:
          "Establishes the CURRENT (pre-improvement) baseline from historical delivery data, so later quarters can be measured against a real starting point.",
        milestones: [["Current Baseline Approved", "2026-08-27"]],
        subtasks: [
          ["Identify Current BA Projects", "2026-08-09", "2026-08-10"],
          ["Collect Historical Delivery Data", "2026-08-11", "2026-08-16"],
          ["Measure Current On-Time Delivery Rate", "2026-08-17", "2026-08-18"],
          [
            "Measure Current First-Review Acceptance Rate",
            "2026-08-19",
            "2026-08-20",
          ],
          [
            "Calculate Current Delivery Excellence Index",
            "2026-08-23",
            "2026-08-24",
          ],
          ["Validate Baseline Results", "2026-08-25", "2026-08-26"],
          ["Approve Current Baseline", "2026-08-27", "2026-08-27"],
        ],
      },
      {
        name: "2. Define Delivery Measurement Framework",
        start: "2026-08-30",
        end: "2026-09-10",
        deliverable: "Delivery Measurement Framework",
        subtasks: [
          ["Define Deliverable Categories", "2026-08-30", "2026-09-01"],
          ["Define Measurement Rules", "2026-09-02", "2026-09-06"],
          ["Define On-Time Delivery Rules", "2026-09-07", "2026-09-08"],
          ["Define First Review Acceptance Rules", "2026-09-09", "2026-09-10"],
        ],
      },
      {
        name: "3. Configure Jira Measurement Setup",
        start: "2026-09-13",
        end: "2026-09-20",
        deliverable: "Jira Measurement Configuration",
        owner: "Jira Admin",
        subtasks: [
          ["Configure Jira Measurement Fields", "2026-09-13", "2026-09-16"],
          ["Configure Jira for Pilot", "2026-09-17", "2026-09-20"],
        ],
      },
      {
        name: "4. Create BA Quality Checklist",
        start: "2026-09-21",
        end: "2026-09-28",
        deliverable: "BA Quality Checklist",
        subtasks: [
          ["Create BA Pre-Submission Checklist", "2026-09-21", "2026-09-28"],
        ],
      },
      {
        name: "5. Select & Prepare Pilot Project",
        start: "2026-09-29",
        end: "2026-10-04",
        subtasks: [
          ["Select One Pilot Project", "2026-09-29", "2026-09-30"],
          ["Train Pilot Team", "2026-10-01", "2026-10-04"],
        ],
      },
      {
        name: "6. Run Pilot & Collect Data",
        start: "2026-10-05",
        end: "2026-10-14",
        deliverable: "Delivery Excellence Pilot",
        subtasks: [
          ["Run Pilot", "2026-10-05", "2026-10-14"],
          ["Collect KPI Data", "2026-10-11", "2026-10-14"],
        ],
      },
      {
        name: "7. Measure & Analyze Results",
        start: "2026-10-15",
        end: "2026-10-20",
        deliverable: "Initial Baseline",
        milestones: [["Pilot Live and measured", "2026-10-21"]],
        subtasks: [
          ["Measure", "2026-10-15", "2026-10-18"],
          ["Analyze Results", "2026-10-19", "2026-10-20"],
        ],
      },
      {
        name: "8. Define Improvements & Next Steps",
        start: "2026-10-21",
        end: "2026-10-22",
        deliverable: "Improvement Backlog",
        subtasks: [["Identify Improvements", "2026-10-21", "2026-10-22"]],
      },
    ],
    "RELEASE 2": [
      {
        name: "1. Enhance Delivery Framework",
        start: "2026-10-26",
        end: "2026-11-09",
        deliverable: "Enhanced Estimation & Dependency Framework",
        owner: "BA Leads",
        subtasks: [
          ["Improve Estimation Framework", "2026-10-26", "2026-11-02"],
          ["Implement Dependency Management", "2026-11-03", "2026-11-09"],
        ],
      },
      {
        name: "2. Strengthen Quality Controls",
        start: "2026-11-10",
        end: "2026-11-22",
        deliverable: "Structured Feedback & Sign-Off Record",
        subtasks: [
          ["Structured Feedback Record", "2026-11-10", "2026-11-16"],
          ["Improve BA Checklist", "2026-11-17", "2026-11-22"],
        ],
      },
      {
        name: "3. Optimize Jira Workflow",
        start: "2026-11-23",
        end: "2026-11-29",
        owner: "Jira Admin",
        subtasks: [["Improve Jira Workflow", "2026-11-23", "2026-11-29"]],
      },
      {
        name: "4. Expand Pilot to Multiple Projects",
        start: "2026-11-30",
        end: "2026-12-15",
        deliverable: "Expanded Pilot Results",
        owner: "BA Leads",
        notes:
          "Roll-out to projects 2, 3 and 4 runs in parallel (separate project teams).",
        subtasks: [
          ["Select 3 Additional Projects", "2026-11-30", "2026-12-02"],
          ["Onboard Project Teams", "2026-12-03", "2026-12-08"],
          [
            "Roll Out Standard Process in project 2",
            "2026-12-09",
            "2026-12-15",
          ],
          [
            "Roll Out Standard Process in project 3",
            "2026-12-09",
            "2026-12-15",
          ],
          [
            "Roll Out Standard Process in project 4",
            "2026-12-09",
            "2026-12-15",
          ],
        ],
      ...
      {
        name: "5. Measure & Compare Performance",
        start: "2026-12-16",
        end: "2026-12-31",
        deliverable: "KPI Dashboard",
        milestones: [
          ["Project 2 measured", "2026-12-27"],
          ["Project 3 measured", "2026-12-31"],
          ["Project 4 measured", "2026-12-31"],
        ],
        subtasks: [
          [
            "Collect and analyze KPI Results for project 1",
            "2026-12-16",
            "2026-12-22",
          ],
          [
            "Collect and analyze KPI Results for project 2",
            "2026-12-23",
            "2026-12-27",
          ],
          [
            "Collect and analyze KPI Results for project 3",
            "2026-12-28",
            "2026-12-31",
          ],
        ],
      ...
      {
        name: "6. Quarterly Review & Improvement Planning",
        start: "2027-01-03",
        end: "2027-01-10",
        subtasks: [
          ["Quarterly Review", "2027-01-03", "2027-01-05"],
          ["Define Improvement Actions", "2027-01-06", "2027-01-10"],
        ],
      },
    ],
    "RELEASE 3": [
      {
        name: "1. Roll Out Across BA Department",
        start: "2027-01-18",
        end: "2027-01-31",
        deliverable: "Department-wide Adoption",
        owner: "BA Leads",
        subtasks: [
          ["Roll Out to All Projects", "2027-01-18", "2027-01-31"],
          ["Onboard BA Teams", "2027-01-24", "2027-01-31"],
        ],
      },
      {
        name: "2. Standardize Delivery Practices",
        start: "2027-02-01",
        end: "2027-02-17",
        deliverable: "Standardized Delivery Process",
        subtasks: [
          ["Standardize BA Process", "2027-02-01", "2027-02-07"],
          ["Standardize Templates", "2027-02-08", "2027-02-11"],
          ["Standardize Jira Usage", "2027-02-14", "2027-02-17"],
        ],
      },
      {
        name: "3. Enable Governance",
        start: "2027-02-18",
        end: "2027-03-03",
        deliverable: "Governance Framework",
        subtasks: [
          ["Define Governance Model", "2027-02-18", "2027-02-24"],
          ["Assign Governance Owners", "2027-02-25", "2027-02-28"],
          ["Launch Governance Reviews", "2027-03-01", "2027-03-03"],
        ],
      },
      {
        name: "4. Monitor Department KPIs",
        start: "2027-03-04",
        end: "2027-03-17",
        deliverable: "Department KPI Dashboard",
        subtasks: [
          ["Collect KPI Results", "2027-03-04", "2027-03-09"],
          ["Monitor KPI Trends", "2027-03-10", "2027-03-14"],
          ["Validate Data Quality", "2027-03-15", "2027-03-17"],
        ],
      },
      {
        name: "5. Conduct Quarterly Review",
        start: "2027-03-18",
        end: "2027-04-01",
        milestones: [["Department Rollout Completed", "2027-04-01"]],
        subtasks: [
          ["Quarterly Review", "2027-03-18", "2027-03-28"],
          ["Lessons Learned", "2027-03-29", "2027-03-30"],
          ["Update Improvement Backlog", "2027-03-31", "2027-04-01"],
        ],
      },
    ],
    "RELEASE 4": [
      {
        name: "1. Optimize Delivery Process",
        start: "2027-04-06",
        end: "2027-04-21",
        deliverable: "Optimized Delivery Process",
        subtasks: [
          ["Review Delivery Process", "2027-04-06", "2027-04-11"],
          ["Simplify Workflow", "2027-04-12", "2027-04-15"],
          ["Optimize Approval Process", "2027-04-18", "2027-04-21"],
        ],
      },
      {
        name: "2. Enhance KPI Reporting",
        start: "2027-04-22",
        end: "2027-05-09",
        deliverable: "Executive KPI Dashboard",
        subtasks: [
          ["Enhance KPI Dashboard", "2027-04-22", "2027-04-28"],
          ["Improve Executive Reports", "2027-04-29", "2027-05-04"],
          ["Define KPI Insights", "2027-05-05", "2027-05-09"],
        ],
      },
      {
        name: "3. Automate Delivery Monitoring",
        start: "2027-05-10",
        end: "2027-06-03",
        deliverable: "Automated KPI Monitoring",
        owner: "Jira Admin",
        notes:
          "Eid al-Adha planning gap (approx. 16–20 May 2027) excluded — verify exact dates against your company holiday calendar.",
        subtasks: [
          ["Identify Automation Opportunities", "2027-05-10", "2027-05-12"],
          ["Automate KPI Calculations", "2027-05-13", "2027-05-27"],
          ["Automate Reports & Notifications", "2027-05-30", "2027-06-03"],
        ],
      },
      {
        name: "4. Institutionalize Continuous Improvement",
        start: "2027-06-06",
        end: "2027-06-15",
        deliverable: "Continuous Improvement Framework",
        subtasks: [
          ["Build Continuous Improvement Backlog", "2027-06-06", "2027-06-08"],
          ["Prioritize Improvements", "2027-06-10", "2027-06-09"],
          ["Define Improvement Governance", "2027-06-13", "2027-06-15"],
        ],
      },
      {
        name: "5. Annual Performance Review",
        start: "2027-06-16",
        end: "2027-06-30",
        deliverable: "Annual Delivery Excellence Report",
        milestones: [
          ["Delivery Excellence Successfully Institutionalized", "2027-06-30"],
        ],
        subtasks: [
          ["Annual KPI Review", "2027-06-16", "2027-06-20"],
          ["Measure Business Value", "2027-06-21", "2027-06-23"],
          ["Capture Lessons Learned", "2027-06-27", "2027-06-24"],
          ["Define Next-Year Roadmap", "2027-06-28", "2027-06-30"],
        ],
      },
    ],
  };
    ...
    primaries.forEach((p, pIdx) => {
      ...
      (p.milestones || []).forEach(([mName, mDate], mIdx) => {
        activities.push(
          task({
            initiativeId,
            name: `Milestone: ${mName}`,
            plannedStart: mDate,
            plannedEnd: mDate,
            milestone: true,
            order: primaries.length + pIdx + (mIdx + 1) * 0.1,
          })
        );
      });
    });
...
const RELEASE_META = {
  ...
  "RELEASE 2": {
    quarter: "Q2",
    quarterTargets: [
      "Pilot Successfully Expanded",
      "KPI Dashboard Live",
      "Q1 vs Q2 Comparison Complete",
    ],
    successCriteria: [
      {
        label: "Estimation framework improved",
        link: "Improve Estimation Framework",
      },
      {
        label: "Dependency management in use",
        link: "Implement Dependency Management",
      },
      { label: "Feedback record live", link: "Structured Feedback Record" },
      {
        label: "Pilot expanded",
        link: "Roll Out Standard Process in project 4",
      },
      { label: "Performance compared to Q1", link: "Quarterly Review" },
    ],
    businessValue: [
      {
        label: "Multiple projects covered",
        link: "Roll Out Standard Process in project 4",
      },
      ...
      {
        label: "KPI Dashboard",
        link: "Collect and analyze KPI Results for project 1",
      },
      {
        label: "Improvement actions defined",
        link: "Define Improvement Actions",
      },
    ],
  ...
  "RELEASE 3": {
    ...
    businessValue: [
      {
        label: "Department-wide adoption",
        link: "Milestone: Department Rollout Completed",
      },
  ...
  "RELEASE 4": {
    quarter: "Q4",
    quarterTargets: [
      "Delivery Excellence Institutionalized",
    ...
    successCriteria: [
      ...
      {
        label: "Executive reporting enhanced",
        link: "Improve Executive Reports",
      },
      {
        label: "KPI calculations automated",
        link: "Automate KPI Calculations",
      },
      {
        label: "Continuous improvement governed",
        link: "Define Improvement Governance",
      },
      { label: "Annual review completed", link: "Annual KPI Review" },
    ],
    businessValue: [
      {
        label: "Optimised Delivery Process",
        link: "Optimize Approval Process",
      },
      { label: "Executive KPI Dashboard", link: "Enhance KPI Dashboard" },
      {
        label: "Automated KPI Monitoring",
        link: "Automate Reports & Notifications",
      },
      {
        label: "Continuous Improvement Framework",
        link: "Build Continuous Improvement Backlog",
      },
      {
        label: "Annual Delivery Excellence Report",
        link: "Measure Business Value",
      },
    ...
    kpiTargets: {
      deliveryIndex: 80,
      onTimeDelivery: 95,
      firstReviewAcceptance: 85,
    },
    valueHeadline: "Continuous Improvement",
    valueMilestone:
      "Milestone: Delivery Excellence Successfully Institutionalized",
  },
};

const INITIAL_RELEASE_REVIEWS = [
  "RELEASE 1",
  "RELEASE 2",
  "RELEASE 3",
  "RELEASE 4",
...
const INITIAL_ALIGNMENTS = [
  {
    ...
    owner: "Mashael",
    attendees: ["Fatima Alghannam", "Mashael"],
    notes: "",
    agreedActions: "",
    actionOwner: "Mashael",
    dueDate: "",
...
function defaultData() {
  return {
    ...
    savedViews: [
      ...
      {
        id: uid("VIEW"),
        name: "Mashael's open actions",
        filter: { owner: "Mashael" },
      },
    ],
...
function leafActivities(activities, releaseId) {
  const scoped = activities.filter(
    (a) => !releaseId || a.initiativeId === releaseId
  );
  const parentIds = new Set(
    scoped.map((a) => a.parentActivityId).filter(Boolean)
  );
...
function activityProgress(activities, act) {
  ...
  return Math.round(
    kids.reduce((t, k) => t + clampProgress(k.progress), 0) / kids.length
  );
}
...
function releaseProgress(data, releaseId) {
  ...
  const pct = Math.round(
    leaves.reduce((t, a) => t + clampProgress(a.progress), 0) / leaves.length
  );
...
function computeObjectiveHealth(data) {
  ...
  const criticalRisks = data.risks.filter((r) => {
    ...
    return (
      lvl === "Critical" &&
      !["Completed", "Closed", "Mitigated"].includes(r.status)
    );
  }).length;
...
const TABS = [
  ...
  { id: "alignments", label: "Stakeholder Alignment", icon: Users },
...
// Activity Log & Settings & Data are hidden on the view-only (non-edit) link
const HIDDEN_IN_VIEW_ONLY = ["log", "settings"];
const VISIBLE_TABS = READ_ONLY
  ? TABS.filter((t) => !HIDDEN_IN_VIEW_ONLY.includes(t.id))
  : TABS;
...
function AppShell({
  ...
  const storedTab = data.ui.activeTab || "overview";
  const activeTab = VISIBLE_TABS.some((t) => t.id === storedTab)
    ? storedTab
    : "overview";
...
function GlobalSearchResults({
  ...
  return (
    <div>
      ...
      {[
        ["Releases", initiatives, "initiatives"],
        ["Activities", activities, "timeline"],
        ["Risks & Dependencies", risks, "risks"],
        ["Stakeholder Alignment", alignments, "alignments"],
      ].map(([label, list, tab]) => (
...
function OverviewTab({
  ...
  const kpiSub = (agg) =>
    agg
      ? `Average of ${agg.milestones} completed milestone${
          agg.milestones === 1 ? "" : "s"
        }`
      : "Not yet measured";
  ...
  // Progress bar against the actual Objective 5 delivery plan (6 Jul 2026 – 30 Jun 2027)
  ...
  const currentQuarter =
    now < planStart
      ? `Before plan start (${fmtDate(OBJECTIVE5_QUARTERS[0].start)})`
      : activeQ
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      >
        <KPICard
          ...
          sub={`Average of ${
            leafActivities(data.activities).length
          } activities`}
        />
        <KPICard
          label="Delivery Excellence Index"
          value={dei ? `${dei.pct}%` : "No data"}
          sub={kpiSub(dei)}
        />
        <KPICard
          label="On-Time Delivery Rate"
          value={otd ? `${otd.pct}%` : "No data"}
          sub={kpiSub(otd)}
        />
        <KPICard
          label="First-Review Acceptance"
          value={fra ? `${fra.pct}%` : "No data"}
          sub={kpiSub(fra)}
        />
 ...
 */
function buildTimelineColumns(view, rangeStart, rangeEnd, initiatives = []) {
  const cols = [];
  const clampDays = (s, e) =>
    Math.max(
      1,
  ...
  // Quarterly (default)
  // Column WIDTHS stay on the fixed 13-week quarter boundaries so the gridlines
  // still line up with the bars, but the LABEL under each quarter is read live
  // from that quarter's release dates, so it never goes stale after an edit.
  return OBJECTIVE5_QUARTERS.map((q) => {
    const relId = Object.keys(RELEASE_META).find(
      (id) => RELEASE_META[id].quarter === q.label
    );
    const rel = initiatives.find((i) => i.id === relId);
    return {
      key: q.label,
      label: q.label,
      sub:
        rel?.plannedStart && rel?.plannedEnd
          ? fmtRange(rel.plannedStart, rel.plannedEnd)
          : q.range,
...
function TimelineTab({
  ...
  const dropReorder = (draggedId, targetAct) => {
    ...
    if (
      ...
      push(
        "You can only reorder within the same release and task level.",
        "error"
      );
      return;
    }
  ...
  const columns = useMemo(
    () => buildTimelineColumns(view, rangeStart, rangeEnd, data.initiatives),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [view, data.initiatives]
  );
  const LABEL_W = 300;
              ...
              return (
                <div key={init.id}>
                  ...
                  >
                    ...
                    >
                      {init.owner} · {releaseProgress(data, init.id).pct}%
                      complete ({releaseProgress(data, init.id).completed}/
                      {releaseProgress(data, init.id).total})
                    </div>
                  </div>
                  {!isCollapsed &&
                    acts.map((act, actIdx) => {
                      ...
                      return (
                        <div key={act.id}>
                          <TimelineRow
                            ...
                            displayProgress={activityProgress(
                              data.activities,
                              act
                            )}
                            onClick={() =>
        ...
        {activity.milestone ? (
          ...
          <div
            title={`${activity.name}\nPlanned: ${fmtDate(
              ...
              activity.status
            } · ${displayProgress ?? activity.progress}%`}
            style={{
              position: "absolute",
              left: `${left}%`,
              width: `${width}%`,
    ...
    if (form.milestone) {
      for (const f of KPI_FIELDS) {
        ...
        if (filled) {
          ...
          if (n < 0 || n > 100)
            return `${f.short}: percentage must be between 0 and 100.`;
        }
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {form.milestone && (
          ...
          >
            <div style={{ fontWeight: 700, color: "#0f2a52", fontSize: 13.5 }}>
              KPI Measurement at this milestone
            </div>
            <div
              style={{
                fontSize: 12,
            ...
            >
              Enter each KPI as a percentage (0–100). Once this milestone is
              marked
              <strong> Completed</strong>, these values are averaged into its
              quarter on the Delivery Performance page — no manual KPI entry
              needed. Required to complete the milestone.
            </div>
            {KPI_FIELDS.map((f) => {
              const target = ((RELEASE_META[form.initiativeId] || {})
                .kpiTargets || {})[f.key];
              const raw = form[f.key];
              const n =
              ...
              return (
                <div key={f.key} style={{ marginBottom: 10 }}>
                  <Field
                    label={`${f.short} (%) *`}
                    error={
                      bad ? "Enter a percentage between 0 and 100" : undefined
                    }
                    hint={
                      !bad
                        ? target == null
                          ? "Baseline quarter — no target set"
                          : `Target ${target}%`
                        : undefined
                    }
                  >
                    ...
                    >
                      ...
                      {n !== null && !bad && target != null && (
                        <Badge tone={n >= target ? "green" : "amber"}>
                          {n >= target
                            ? "Meets target"
                            : `${(n - target).toFixed(1)} pts vs target`}
                        </Badge>
                      )}
                    </div>
                  </Field>
            ...
            >
              ...
              <div>
                ...
                >
                  <div
                    style={{
                      width: `${releaseProgress(data, init.id).pct}%`,
                      height: "100%",
                      background: "#0f2a52",
                    }}
                  />
                ...
                <div style={{ fontSize: 11.5, color: "#8592a3", marginTop: 3 }}>
                  {releaseProgress(data, init.id).pct}% complete ·{" "}
                  {releaseProgress(data, init.id).completed}/
                  {releaseProgress(data, init.id).total} activities · Owner:{" "}
                  {init.owner}
                </div>
              </div>
              <div
            ...
            <tbody>
              {list.map((init) => (
                <tr key={init.id} style={{ borderBottom: "1px solid #f0f2f5" }}>
                  ...
                  <td style={{ padding: "10px 12px" }}>
                    {releaseProgress(data, init.id).pct}%
                  </td>
...
function InitiativeDrawer({
  ...
  const validate = () => {
    ...
    if (
      ...
      return `Cannot mark this release Completed — ${
        derivedProgress.total - derivedProgress.completed
      } of ${derivedProgress.total} activities are still open.`;
    }
    return "";
  };
  ...
  return (
    <Modal
      open
      onClose={onClose}
      title={isNew ? "Add Release" : `${form.id} · ${form.name || "Release"}`}
      width={680}
      footer={
        <>
          <Button variant="secondary" onClick={onClose}>
          ...
          <Button variant="primary" icon={Save} onClick={save}>
            {isNew ? "Add Release" : "Save Changes"}
          </Button>
        </>
      }
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        >
          ...
          <Field
            label="Progress (%)"
            hint="Calculated from this release's activities — not entered by hand"
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              >
                {derivedProgress.completed}/{derivedProgress.total} done
              </span>
            </div>
          </Field>
        ...
        {!isNew && (
          <div>
            ...
            >
              Activities under this release ({activities.length})
            </div>
            <div
              style={{
                display: "flex",
...
const KPI_FIELDS = [
  {
    key: "deliveryIndex",
    metric: "Delivery Excellence Index",
    short: "Delivery Excellence",
  },
  {
    key: "onTimeDelivery",
    metric: "5.1 On-Time Delivery Rate",
    short: "On-Time",
  },
  {
    key: "firstReviewAcceptance",
    metric: "5.2 First-Review Acceptance Rate",
    short: "First Review",
  },
];
...
function kpiMilestonesFor(data, releaseId) {
  return data.activities.filter(
    (a) => isKpiSource(a) && (!releaseId || a.initiativeId === releaseId)
  );
}
/**
...
function aggregateKpi(data, field, releaseId) {
  const rows = kpiMilestonesFor(data, releaseId).filter((a) =>
    hasKpiValue(a, field.key)
  );
  if (!rows.length) return null;
  const avg = rows.reduce((s, a) => s + Number(a[field.key]), 0) / rows.length;
  const target = releaseId
    ? ((RELEASE_META[releaseId] || {}).kpiTargets || {})[field.key]
    : null;
  const thresholds = (data.settings && data.settings.performanceThresholds) || {
    aboveTarget: 5,
    slightlyBelow: 5,
  };
  const pct = Number(avg.toFixed(1));
  // No target ⇒ Q1 is the baseline quarter; TOTAL spans quarters so has no single target.
  let status = releaseId ? "Baseline" : "Aggregate",
    variance = null;
  if (target != null) {
  ...
  return {
    ...
    sources: rows.map((a) => a.name.replace("Milestone: ", "")),
  };
}
...
function resolveChecklist(data, releaseId, items) {
  ...
  return (items || []).map((it) => {
    const hit = acts.find(
      (a) => a.name === it.link || a.name.endsWith(it.link)
    );
    return {
      label: it.label,
      done: !!hit && hit.status === "Completed",
      missing: !hit,
    };
  });
}
function currentReleaseId(data) {
  ...
  const active = data.initiatives
    .filter((i) => !i.archived)
    .sort((a, b) => a.order - b.order);
  const inWindow = active.find(
    (i) => i.plannedStart <= today && today <= i.plannedEnd
  );
...
function releaseHealth(data, releaseId) {
  ...
  if (init.status === "Completed")
    return { label: "Completed", tone: "green", color: "#0f2a52" };
  const overdue = data.activities.filter(
    (a) => a.initiativeId === releaseId && isOverdue(a)
  ).length;
  if (init.status === "Delayed" || overdue > 3)
    return { label: "Delayed", tone: "red", color: "#b91c1c" };
  if (init.status === "At Risk" || overdue > 0)
    return { label: "At Risk", tone: "amber", color: "#c2410c" };
...
const ChecklistRow = ({ label, done, missing }) => (
  <div
    style={{
      ...
      fontSize: 13,
      padding: "3px 0",
      color: done ? "#1c2733" : "#64748b",
    }}
  >
    <span
      aria-hidden
      style={{ color: done ? "#1a7f4b" : "#c7d2e2", fontWeight: 700 }}
    >
      {done ? "✔" : "○"}
    </span>
    ...
    {missing && (
      <span
        title="No matching activity found in the plan"
        style={{ fontSize: 10.5, color: "#b8860b" }}
      >
        (unlinked)
      </span>
    )}
...
function DeliveryPerformanceTab({ data, update, log, push }) {
  ...
  const releases = data.initiatives
    .filter((i) => !i.archived)
    .sort((a, b) => a.order - b.order);
  const quarters = releases
    .map((r) => ({ q: (RELEASE_META[r.id] || {}).quarter, id: r.id }))
    .filter((x) => x.q);
  const isTotal = scope === "Total";
  const scopeRel = isTotal
    ? null
    : releases.find((r) => (RELEASE_META[r.id] || {}).quarter === scope);
  ...
  const objectiveProgress = (() => {
    ...
    return acts.length
      ? Math.round(
          acts.reduce((s, a) => s + clampProgress(a.progress), 0) / acts.length
        )
      : 0;
  })();
  ...
  const valueAchieved = (rid) => {
    ...
    const hit = data.activities.find(
      (a) => a.initiativeId === rid && a.name === m
    );
  ...
  const totalCoverage = coverageSeries.reduce(
    (best, c) => (c.actual >= best.actual ? c : best),
    { actual: 0, planned: maxPlanned }
  );
  ...
  const trendData = useMemo(() => {
    ...
    return ms.map((m) => {
      ...
      for (const f of KPI_FIELDS)
        if (hasKpiValue(m, f.key)) row[f.short] = Number(m[f.key]);
      return row;
    });
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [data.activities, data.settings, scope]);
    ...
    for (const sc of scopes) {
      ...
      for (const f of KPI_FIELDS) {
        ...
        rows.push({
          ...
          quarterLabel: sc,
          relName:
            (data.initiatives.find((i) => i.id === rid) || {}).name || "—",
          short: f.short,
          target: a.target,
          pct: a.pct,
          status: a.status,
  ...
  const setCoverage = (rid, v) => {
    ...
    update((p) => ({
      ...p,
      pilotCoverageActual: { ...(p.pilotCoverageActual || {}), [rid]: n },
    }));
  };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      >
        ...
        >
          ...
          {["Total", ...quarters.map((q) => q.q)].map((s) => {
            const on = scope === s;
            const rid =
              s === "Total" ? "" : (quarters.find((q) => q.q === s) || {}).id;
            return (
              <button
                key={s}
                onClick={() => setScope(s)}
        ...
        <Badge tone="navy">
          {kpiMilestonesFor(data, isTotal ? undefined : scopeRelId).length}{" "}
          completed milestone(s) measured
        </Badge>
      </div>
      ...
      >
        {isTotal ? (
          <>
            ...
            >
              <div style={{ ...capLabel, color: "#a9bcdd" }}>
                Overall Progress
              </div>
              <div style={{ fontSize: 13, color: "#c4d0e5", marginTop: 4 }}>
                Objective 5
              </div>
            ...
            <div style={panel}>
              ...
              <div style={bigNum}>
                {totalCoverage.actual} / {maxPlanned}
              </div>
              <div style={{ fontSize: 12, color: "#8592a3", marginTop: 4 }}>
                Peak adoption reached so far
              </div>
            </div>
            <div style={panel}>
              ...
              <div style={{ display: "flex", gap: 6, marginTop: 8 }}>
                ...
                {curRelId && (
                  <Badge tone={releaseHealth(data, curRelId).tone}>
                    {releaseHealth(data, curRelId).label}
                  </Badge>
                )}
              </div>
            </div>
            <div style={panel}>
              ...
              <div style={{ marginTop: 6 }}>
                {releases.map((r) => (
                  <ChecklistRow
                    key={r.id}
                    label={`${metaOf(r.id).quarter} · ${
                      metaOf(r.id).valueHeadline
                    }`}
                    done={valueAchieved(r.id)}
                  />
                ))}
              </div>
            </div>
          ...
          <>
            <div style={panel}>
              <div style={capLabel}>Projects Covered</div>
              <div style={bigNum}>
                {Number(coverage[scopeRelId] ?? 0)} /{" "}
                {metaOf(scopeRelId).pilotCoveragePlanned}
              </div>
              <div
                style={{
                  height: 7,
              ...
              {!READ_ONLY && (
                <div style={{ marginTop: 10 }}>
                  <Input
                    type="number"
                    min={0}
                    max={metaOf(scopeRelId).pilotCoveragePlanned}
                    value={Number(coverage[scopeRelId] ?? 0)}
                    onChange={(e) => setCoverage(scopeRelId, e.target.value)}
                    aria-label="Projects onboarded"
                    style={{ width: 110 }}
                  />
                </div>
              )}
            ...
            >
              ...
              <div style={{ fontSize: 17, fontWeight: 800, marginTop: 6 }}>
                {scopeRel ? scopeRel.name : "—"}
              </div>
              <div style={{ fontSize: 12, color: "#c4d0e5", marginTop: 4 }}>
                {scopeRel
                  ? `${scopeRel.plannedStart} → ${scopeRel.plannedEnd}`
                  : ""}
              </div>
              {scopeHealth && (
                <span
                ...
                >
                  <Circle
                    size={9}
                    fill={scopeHealth.color}
                    color={scopeHealth.color}
                  />{" "}
                  {scopeHealth.label}
                </span>
              )}
            ...
            <div style={panel}>
              ...
              <div style={{ fontSize: 12, color: "#8592a3", marginTop: 4 }}>
                {scopeProg
                  ? `${scopeProg.completed} / ${scopeProg.total} activities completed`
                  : "—"}
              </div>
              <div
                style={{
              ...
              >
                <div
                  style={{
                    width: `${scopeProg ? scopeProg.pct : 0}%`,
                    height: "100%",
                    background: "#1a7f4b",
                  }}
                />
            ...
            <div style={panel}>
              ...
              <div
                style={{
                  fontSize: 16,
                  fontWeight: 800,
                  color: valueAchieved(scopeRelId) ? "#1a7f4b" : "#0f2a52",
                  marginTop: 6,
                }}
              >
              ...
              >
                {resolveChecklist(
                  data,
                  scopeRelId,
                  metaOf(scopeRelId).businessValue
                )
                  .slice(0, 5)
                  .map((v) => (
      ...
      <div>
        <div style={title}>
          KPIs {isTotal ? "· Total (all completed milestones)" : `· ${scope}`}
        </div>
        <div
          style={{
            display: "grid",
        ...
        >
          {kpiFigures.map(({ field, agg }) => {
            ...
            const projects = isTotal
              ? Math.max(
                  0,
                  ...Object.values(data.pilotCoverageActual || {}).map(Number)
                )
            ...
            return (
              <div key={field.key} style={panel}>
                ...
                >
                  ...
                  {agg && agg.target != null && (
                    <Badge>Target {agg.target}%</Badge>
                  )}
                  {agg && agg.variance != null && (
                    <Badge tone={agg.variance >= 0 ? "green" : "red"}>
                      {agg.variance > 0 ? "+" : ""}
                      {agg.variance} pts
                    </Badge>
                  )}
      ...
      <div style={panel}>
        <div style={title}>
          {isTotal
            ? "Quarterly Trend"
            : `Milestone measurements within ${scope}`}
        </div>
        {!hasTrend ? (
          <EmptyState
            message={
      ...
      >
        <div style={panel}>
          ...
          <div style={{ fontSize: 12, color: "#8592a3", marginBottom: 10 }}>
            Projects using the framework, quarter by quarter
          </div>
          {coverageSeries.map((c) => {
            const pct = Math.round((c.planned / maxPlanned) * 100);
            const donePct = c.planned
              ? Math.round((c.actual / c.planned) * 100)
              : 0;
            ...
            return (
              <div
                ...
                style={{
                  marginBottom: 10,
                  padding: on ? "6px 8px" : 0,
                  background: on ? "#f4f6f9" : "transparent",
                  borderRadius: 8,
                }}
              >
                <div
                ...
                >
                  <span style={{ fontWeight: 700, color: "#0f2a52" }}>
                    {c.q}
                  </span>
                  <span style={{ color: "#64748b" }}>
                    <strong style={{ color: "#1c2733" }}>{c.actual}</strong> /{" "}
                    {c.planned} projects
                  </span>
                </div>
                <div
        ...
        <div style={panel}>
          ...
          <div style={{ fontSize: 12, color: "#8592a3", marginBottom: 10 }}>
            Value released at the end of each quarter
          </div>
                  ...
                  <div>
                    ...
                    <div
                      style={{
                        ...
                        color: done ? "#1a7f4b" : "#334155",
                      }}
                    >
                      {metaOf(c.id).valueHeadline}
                    </div>
                    <span style={{ position: "absolute", left: -9999 }}>
                      {done ? "delivered" : "not delivered"}
                    </span>
                  </div>
                </div>
          ...
          <tbody>
            ...
            {kpiRows.length === 0 && (
              <tr>
                ...
                >
                  No completed milestones with KPI values
                  {isTotal ? "" : ` in ${scope}`} yet.
                </td>
              </tr>
            )}
          </tbody>
      ...
      >
        ...
        >
          <div style={{ fontWeight: 700, color: "#0f2a52", fontSize: 14 }}>
            Improvement Actions {isTotal ? "" : `· ${scope}`}
          </div>
          <Button
            variant="secondary"
            icon={Plus}
            onClick={() =>
              setActionDrawer({
                ...
                form: {
                  id: uid("IMP"),
                  releaseId: scopeRelId || releases[0]?.id || "",
                  action: "",
                  owner: data.settings.objectiveOwner,
                  status: "Open",
                  dueDate: "",
        ...
        >
          ...
          <tbody>
            {actions.map((a) => {
              const overdueAct =
                a.dueDate && a.dueDate < todayISO() && a.status !== "Completed";
              return (
                <tr key={a.id} style={{ borderBottom: "1px solid #f0f2f5" }}>
                  ...
                  >
                    {metaOf(a.releaseId).quarter}
                  </td>
                  <td style={{ padding: "9px 12px" }}>
                    <button
                      onClick={() =>
                        setActionDrawer({ isNew: false, form: { ...a } })
                      }
                      style={{
                        background: "none",
                        border: "none",
                  ...
                  <td
                    style={{
                      padding: "9px 12px",
                      color: overdueAct ? "#a3271f" : "#334155",
                    }}
                  >
...
function ImprovementActionDrawer({ data, update, log, push, state, onClose }) {
  ...
  const save = () => {
    if (!form.action.trim()) {
      push("Action description is required", "error");
      return;
    }
    update((p) => {
      ...
      return {
        ...p,
        improvementActions: exists
          ? list.map((x) => (x.id === form.id ? form : x))
          : [...list, form],
      };
    });
    log({
      action: state.isNew ? "Added" : "Edited",
      recordType: "Improvement Action",
      recordName: form.action,
      previousValue: "",
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      width={560}
      title={state.isNew ? "Add Improvement Action" : "Improvement Action"}
      footer={
        <>
          <Button variant="secondary" onClick={onClose}>
            Cancel
          ...
          <Field label="Release / Quarter">
            ...
            >
              {data.initiatives
                ...
                .map((i) => (
                  <option key={i.id} value={i.id}>
                    {(RELEASE_META[i.id] || {}).quarter} · {i.name}
                  </option>
                ))}
            </Select>
          </Field>
  ...
  const doImport = (mode) => {
    ...
    update((p) => {
      ...
      return {
        ...
        improvementActions: mergeArr(
          p.improvementActions || [],
          parsed.improvementActions || []
        ),
        releaseReviews: mergeArr(
          p.releaseReviews || [],
          parsed.releaseReviews || []
        ),
      ...
      >
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
          ...
          <Button
            ...
            icon={Download}
            onClick={() =>
              exportCSV(data.initiatives, "releases.csv", [
                "id",
                "name",
                "owner",
                "status",
      ...
      {importState && (
        ...
        >
          <p style={{ fontSize: 13.5, color: "#334155" }}>
            ...
            releases, {importState.parsed.activities?.length ?? 0} activities,{" "}
            {importState.parsed.kpiResults?.length ?? 0} KPI results,{" "}
            {importState.parsed.risks?.length ?? 0} risk records, and{" "}
